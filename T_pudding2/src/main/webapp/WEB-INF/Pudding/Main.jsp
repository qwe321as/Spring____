                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="yummyDropdown">
                                        <a class="dropdown-item" href="${path}/resources/index.html">좋아요순위</a>
                                        <a class="dropdown-item" href="${path}/resources/archive.html">인기도순위</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="puddingmusic_chart.ms">Cart</a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="welcome-single-slide">
            ...
            <div class="project_title">
                <div class="post-date-commnents d-flex">
                    ...
                    <a href="${path}/resources/#">5 Comment</a>
                </div>
                        ...
                        <div class="col-12">
                            <div class="single-post wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="post-content">
                                    ...
                                    <a href="${path}/resources/#" class="read-more">Continue Reading..</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="footer-content">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item">
                                   <a class="nav-link" href="${path}/resources/#">Pudding chart</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${path}/resources/#">Pudding DJ</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${path}/resources/#">Boarder</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${path}/resources/archive.html">QnA</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${path}/resources/#">Notice</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="${path}/resources/contact.html">관리자페이지</a>
                                </li>
                            </ul>
                            </div>
                        </nav>
