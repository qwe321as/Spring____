			...
			<div class="row">
				<div class="12u">
					<section style="width: 1100px;">
						...
						<br>
							<h2>QNA</h2>
                     <p class="subtitle">QNA 수정하기</p>
						</header>
<form action="updateqna.ad" method="post">
	<table border="1" align="center" cellspacing="0" width="100%">
		<tr>
			<td>
			<input type="hidden" name="qna_no"  value="${qna.qna_no }">
			<input type="text" name="qna_category" style="width: 100%;height: 55.98438px;" placeholder="카테고리을 입력하세요." value="${qna.qna_category }" ></td>
		</tr>
		<tr>
			<td><input type="text" name="qna_qustion" style="width: 100%;height: 55.98438px;" placeholder="질문을 입력하세요" value="${qna.qna_qustion }" ></td>
		</tr>
		<tr>
		<tr>
			<td style="height: 430px;"><textarea cols="100%" style="resize: none;width: 1200px;height: 406px;" placeholder="답을 입력하세요."  name="qna_answer" >${qna.qna_answer }</textarea> 
		</tr>
		<tr>
