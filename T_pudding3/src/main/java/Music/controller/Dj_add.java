...
public ModelAndView doAction() {
		/*
		 * if(session.getAttribute("loginInfo") == null) { ModelAndView mav = new
		 * ModelAndView(); session.setAttribute("destination","redirect:/addDj.ms");
		 * String login = "redirect:/loginForm.me"; mav.setViewName(login); return mav;
		 * } else {
}
		 */
