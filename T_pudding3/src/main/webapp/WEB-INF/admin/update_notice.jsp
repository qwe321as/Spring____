...
<form action="updateNotice.ad" method="post">
	<table border="1" align="center" cellspacing="0" width="100%">
		<tr>
			...
			<input type="text" name="notice_title" style="width: 100%;height: 55.98438px;" placeholder="제목을 입력하세요." value="${notice.notice_title }"></td>
		</tr>
		<tr>
		<tr>
			<td style="height: 430px;"><textarea cols="100%" style="resize: none;width: 1200px;height: 406px;" placeholder="내용을 입력하세요."  name="notice_content" >${notice.notice_content }</textarea> 
		</tr>
		<tr>
