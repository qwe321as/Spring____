						...
						<div class="collapse navbar-collapse justify-content-center"
							...
							<ul class="navbar-nav" id="yummy-nav">
								...
								<li class="nav-item"><a class="nav-link" href="c_Djlist.ms">Pudding
										DJ</a></li>
								<li class="nav-item"><a class="nav-link" href="listcart.ms">Wishlist</a>
								</li>
			...
			<div class="row justify-content-center">
				<div class="col-12 col-lg-8">
					<div class="row">
						...
						<c:forEach items="${listrecount }" begin="0" step="1" end="3"
							var="recount">
					...
					<div class="blog-sidebar mt-5 mt-lg-0">
										...
										<tr>
											...
											<td align="center"><a
												href="mainheart.ms?musicheart=${heart.music_heart }&mno=${heart.mno}">
													...
													src="<%=request.getContextPath() %>/resources/img/icon/하트.png">
											</a>${heart.music_heart }</td>
										</tr>
									</c:forEach>
									<tr><td colspan="5" style="text-align: right;"><a href="puddingmusic_heartchart.ms" class="read-more" >MORE</a>
								</td></tr>
							</table>
						</div>
						<br>
						...
						<div class="single-widget-area subscribe_widget text-center">
							...
							<table align="center" style="width: 100%">
								...
								<tr><td colspan="5" style="text-align: right;"><a href="puddingmusic_recountchart.ms" class="read-more" >MORE</a>
								</td></tr>
