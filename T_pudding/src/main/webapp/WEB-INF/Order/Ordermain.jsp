...
<div class="breadcumb-area">
  ...
  <tr>
  	...
  	<a href="insertorder.od?orderuser=${'최지훈'}">결제하기<img style="width: 35px" src="<%=request.getContextPath() %>/resources/img/icon/구매.png" ></a> </td>
  </tr>
  </c:if>
  ...
  <tr>
  	<td colspan="5" style="text-align: right;font-weight: bolder;padding-top: 17px;"> 
  	<a href="insertorderone.od?orderuser=${'최지훈'}&mno=${music.mno}">결제하기<img style="width: 35px" src="<%=request.getContextPath() %>/resources/img/icon/구매.png" ></a> </td>
  </tr>
