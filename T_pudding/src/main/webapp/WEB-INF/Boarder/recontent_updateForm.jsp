...
<body>
	...
	<div id="page">
		...
		<!-- 글번호 -->
		<tr>
		<td>작성자<input type="hidden"  name="recontentno" value="${recontent.recontentno }"></td>
		<td><input type="text" disabled="disabled"  readonly="readonly" name="recontent_writer" value="${recontent.recontent_writer } "></td>
		</tr>
		<tr>
		<td>댓글 내용</td>
		<td><textarea name="recontent_content" id="abc" rows="5" cols="50">${recontent.recontent_content }</textarea></td>
		</tr>
		<tr>
		<td>작성자</td>
		<td><input type="password" name="recontent_passwd" value="${recontent.recontent_passwd } "></td>
		</tr>
		<tr>
		<td colspan=2><input type="submit" value="댓글수정하기"></td>
		</tr>
		</table>
		</form>
