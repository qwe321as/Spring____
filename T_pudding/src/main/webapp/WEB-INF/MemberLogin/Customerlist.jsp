				...
				<div class="12u">
					<section style="width: 1100px;">
                     ...
                     <p class="subtitle">회원을 삭제 할 수 있습니다.</p>
						...
						<form action="admin_customerlist.me" method="post" style="text-align: right;padding-bottom: 20px;">
						...
						<table border=1 style="width: 100%">
							<tr>
                        		<td style="text-align: center; width: 10%">회원번호</td>
                        		<td style="text-align: center; width: 30%">이름</td>
                        		<td style="text-align: center; width: 20%">아이디</td>
                        		<td style="text-align: center; width: 30% ">비밀번호</td>
                        		<td style="text-align: center; width: 10% ">이메일</td>
                        		<td style="text-align: center; width: 10% ">휴대폰번호</td>
                        		<td style="text-align: center; width: 10% ">삭제</td>
                     		</tr>
